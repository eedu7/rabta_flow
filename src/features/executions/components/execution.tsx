                ...
                {execution.error && (
                    <div className="mt-6 p-4 bg-red-50 rounded-md space-y-3">
                        ...
                        {execution.errorStack && (
                            <Collapsible onOpenChange={setShowStackTrace} open={showStackTrace}>
                                <CollapsibleTrigger asChild>
                                    <Button className="text-red-900 hover:bg-red-100 w-full" size="sm" variant="ghost">
                                        {showStackTrace ? "Hide stack trace" : "Show stack tace"}
                                    </Button>
                                </CollapsibleTrigger>
                                <CollapsibleContent>
                                    <pre className="text-xs font-medium text-red-800 overflow-auto mt-2 p-2 bg-red-100 rounded">
                                        {execution.errorStack}
                                    </pre>
                                </CollapsibleContent>
                            </Collapsible>

...
export function EntityContainer({ children, pagination, header, search }: EntityContainerProps) {
    return (
...
export function EntityPagination({ page, onPageChange, totalPages, disabled }: EntityPaginationProps) {
    return (
...
export function EntityList<T>({ items, renderItem, className, emptyView, getKey }: EntityListProps<T>) {
                ...
                <CardContent className="flex flex-row items-center justify-between p-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            {Boolean(subtitle) && <CardDescription className="text-xs">{subtitle}</CardDescription>}
                        </div>
                    </div>
                    {(actions || onRemove) && (
                            ...
                            {onRemove && (
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button onClick={(e) => e.stopPropagation()} size="icon" variant="ghost">
